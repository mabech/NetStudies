...
namespace NewLaunch.Models
{
    public class RestaurantController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Link,LinkImage")] Restaurant restaurant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,Link,LinkImage")] Restaurant restaurant)
        {
            if (ModelState.IsValid)
            {
